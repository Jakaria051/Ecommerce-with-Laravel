        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{ url('admin/add-edit-product') }}" style="max-width: 150px; float: right; display:inline-block;"  class="btn btn-block btn-info">Add product</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                @foreach ($products as $product)
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        @else
                        <img style="width:100px;" src="{{ asset('images/product_images/small/no_image.png') }}" alt="">
                        @endif
                       </td>
                    ...
                    <td>
                        @if ($product->status == 1)
                          <a class="updateProductStatus" id="product-{{ $product->id }}"
                            product_id="{{ $product->id }}" href="javascript:void(0)"><i class="fas fa-toggle-on" status="Active"></i></a>
                        @else
                        <a class="updateProductStatus" id="product-{{ $product->id }}"
                            product_id="{{ $product->id }}" href="javascript:void(0)"><i class="fas fa-toggle-off" status="Inactive"></i></a>
                        @endif
                    </td>
